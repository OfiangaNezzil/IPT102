...
namespace LaundrySystem.Framework.Commands
{
    public class CreateCustomer
    {
        ...
        public CreateCustomer(IRepository<Customer> repository, ICustomerCommand commands, string connectionString)
        {
        ...
        public async Task<bool> ExecuteAsync(string name, DateTime laundryDate)
        {
